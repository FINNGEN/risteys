...
** name: `finngen_R13_endpoint_core_noncore_3.0.added_omit__XXH64_2117be9ae10b1e3e.csv`
** source: Merging of `finngen_R13_endpoint_core_noncore_3.0.xlsx` and `OMIT` column from `Endpoints_Controls_FINNGEN_ENDPOINTS_DF13_Final_2025-08-14.xlsx` - FinnGen clinical team - https://github.com/FINNGEN/Df12-endpoint-and-control-definitions/[GitHub]

* [[file-endp-main-tag]]FinnGen endpoint main tag
** name: `FINNGEN_ENDPOINTS_DF13_Final_2025-08-14.names_tagged_ordered__XXH64_2a214a70d8ce9dc9.txt`
...
** name: `corrected-endpoint-descriptions.airtable-export.2025-08-25__XXH64_07042af680a7b81d.csv`
** source: Risteys Airtable

* [[file-excluded_endp]]FinRegistry excluded endpoints
** name: `excluded_endpoints_FR10_FG13v3__XXH64_9c18defcdc195176.csv`
...
** name: `key_figures_all_2025-08-22__XXH64_83f42eb589f0c9ba.csv`
** source: Risteys pipeline
...
** name: `distribution_age_2025-08-22__XXH64_4303b82f44844f82.csv`
** source: Risteys pipeline

* [[file-distrib-year-FG]]Risteys FinnGen year distributions
** name: `distribution_year_2025-08-22__XXH64_9a1ccbb54852aee1.csv`
** source: Risteys pipeline
...
** name: `all_cumulative_incidence__XXH64_44f2b28d605e3cf6.csv`
** source: Risteys pipeline
...
* [[file-corr-pheno-geno]]FinnGen phenotypic + genotypic correlations
** name: `corr_pheno-fg-r13.0_geno-fg-r13.0_full-join__2025-08-25__XXH64_6c077f125584596a.csv.zst`
...
* [[file-coloc-variants]]FinnGen coloc variants
** name: `r13.autoreport.compare.pval_lt_5e_08_r2_gt_0_8_keep_cs.variants__XXH64_3f92be1082ec43ad.csv`
...
** name: `upset_plots_DF13v3_2025-09-05__XXH64_08ea8627a3f5c401.tar.zst`
** source: Harri S, FinnGen Phenotype team

* [[file-codewas-endpoints]] CodeWAS Endpoints
** name: `codewas-from-xwas__XXH64_49866995add4f45a.jsonl.zst`
...
copy (
    with source as (
        select * from codewas_endpoints_df13_v3 as counts
...
* [[file-labwas]] LabWAS data
** name: `labwas-from-xwas_XXH64_d96847b0b6eb8eb6.jsonl.zst`
** source: Red CodeWAS data from Javier G-T as a DuckDB file, FinnGen Phenotype Team; then applied SQL query with DuckDB:
+
[source,sql]
----
copy (
    ...
    SELECT
        ...
        CAST(labwas_endpoints_df13_v3.CONCEPT_ID as VARCHAR) AS OMOP_Concept_ID,
    ...
    FROM labwas_endpoints_df13_v3
    LEFT JOIN omop ON labwas_endpoints_df13_v3.CONCEPT_ID = omop.concept_id
    WHERE (
